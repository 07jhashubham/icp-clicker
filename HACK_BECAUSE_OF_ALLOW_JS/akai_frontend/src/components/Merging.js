...
export default function Merging({ boxes, setBoxes }) {
    ...
    const handleDrop = (e, dropIndex) => {
        ...
        if (draggedBox && droppedBox && draggedBox.level === droppedBox.level) {
            ...
            setBoxes((prevBoxes) => prevBoxes
                .filter((b) => b.index !== parseInt(dragIndex) && b.index !== dropIndex)
    ...
    return (<div className="frame-container" style={{
            position: "relative",
      ...
      {/* Adding shards.png */}
      <img src="shards.png" alt="Shards" style={{
            position: "absolute",
      ...
      <div style={{
        ...
        {/* lostCoin Image */}
        <img src="lostCoin.png" alt="Lost Coin" style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* tpN Image */}
            <img src="tpN.png" alt="TPN Image" style={{
          ...
          <div style={{
            ...
            <img src="Line6.png" alt="Line Fill" style={{
            position: "absolute",
            top: 0,
            left: 0,
            width: `${lineFillPercentage}%`, // Dynamically update width based on state
            height: "100%",
            objectFit: "cover",
        }}/>
          </div>
      ...
      <div className="gold-container" style={{
            position: "absolute",
            top: "10px",
            left: "10px",
            width: "150px",
      ...
      <div className="elexer-container" style={{
            position: "absolute",
            top: "10px",
            right: "10px",
        ...
        <img src="elexerRectange.png" alt="Elexer Rectangle" style={{
            width: "100%", // Full width of the container
            height: "auto",
            zIndex: 2,
        }}/>
        ...
        <div className="flex-row mx-4" style={{
            display: "flex",
            flexDirection: "row",
            alignItems: "center",
          ...
          {/* Vector Image */}
          <img src="Vector.png" alt="Vector Icon" style={{
            width: "20px",
            height: "auto",
        }}/>
          ...
          <div className="right-content" style={{
            ...
            height: "2px",
            backgroundColor: "black",
            marginBottom: "5px", // Space between line and text
        }}></div>

            {/* Yellow text */}
            <p className=" text-white font-mono" style={{
            fontSize: "14px",
            margin: "0",
        }}>
              200/500
      ...
      <div className="grid" style={{
        ...
        {placeholders.map((_, index) => {
            ...
            return (<div key={index} data-index={index} className="alien-box" style={{
                    width: "90px",
                    height: "75px",
                    ...
                    position: "relative",
                    overflow: "hidden",
                }} draggable={box ? true : false} onDragStart={(e) => handleDragStart(e, index)} onDrop={(e) => handleDrop(e, index)} onDragOver={handleDragOver} onTouchStart={(e) => handleTouchStart(e, index)} onTouchMove={handleTouchMove} onTouchEnd={() => setDraggingBox(null)}>
              <img src="box.png" alt="Container" style={{
                    width: "100%",
                    height: "100%",
                    position: "absolute",
                    top: 0,
              ...
              {box && (<img src={alienImages[box.level - 1]} alt={`Alien ${box.level}`} style={{
                        width: "80%",
                        height: "70%",
                        objectFit: "contain",
                        zIndex: 2,
