    ...
    return (<>
      ...
      <div className="footer-container" style={{
        ...
        <div style={{
          ...
          {selectedIcon === "profile" && (<img src="/hover.png" alt="Hover" style={{
                width: "40px", // Adjust size as necessary
                height: "auto",
        ...
        <div style={{
          ...
          {selectedIcon === "home" && (<img src="/hover.png" alt="Hover" style={{
                width: "40px", // Adjust size as necessary
                height: "auto",
        ...
        <div style={{
          ...
          <img src="/task.png" alt="Task" style={{
            width: "40px", // Adjust size as necessary
            height: "auto",
            zIndex: 2,
        }}/>
          {/* Conditionally render hover image under task */}
          {selectedIcon === "task" && (<img src="/hover.png" alt="Hover" style={{
                width: "40px", // Adjust size as necessary
                height: "auto",
